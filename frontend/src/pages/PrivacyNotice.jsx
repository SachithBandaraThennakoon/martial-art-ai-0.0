...
export default function PrivacyNotice() {
  return (
    <main className="page legal-page">
      ...
      <p>Practice tapes are scheduled for deletion after 90 days, contact messages after 365 days, and expired, used, or revoked authentication records after 30 days. Core account and training records remain until you delete your account, unless a legal hold requires us to retain them. Backups expire according to their retention schedule.</p>
