...
export default function Terms() {
  return (
    <main className="page legal-page">
      ...
      <h1>Terms of use</h1>
      <p>People of different ages may use XMartialArt with appropriate parent or guardian support. Keep your credentials private and provide accurate registration information.</p>
      ...
      <p>Do not attack the service, evade access controls, upload unlawful material, interfere with other users, or use automated feedback to claim professional certification.</p>
      <h2>Your content and account closure</h2>
